...
export default class extends Controller {
  ...
  sync() {
    ...
    this.contentTargets.forEach(panel => {
      ...
      if (panel.showPopover) {
        ...
        if (this.openValue && !shown) panel.showPopover()
        if (!this.openValue && shown) panel.hidePopover()
      }
      if (this.openValue) this.place(panel)
    })
    this.openValue ? this.track() : this.untrack()
  }
  ...
  reposition() {
    ...
    this.contentTargets.forEach(panel => this.place(panel))
  }
